...
public class Board
{
    ...
    for (int i = 0; i < gameboard.length; i++)
      {
        ...
        for (int i = 0; i < gameboard.length; i++)
        {
            for (int j = 0; j < gameboard[0].length; j++)
            {
                ...
                gameboard[i][j].show();
                tileValues[random] = tileValues[count];
                count--;
            }
        }
    }
    ...
    {
        int matches = (gameboard.length * gameboard[0].length);
        int count = 0;
        for (int i = 0; i < gameboard.length; i++)
        {
            for (int j = 0; j < gameboard[i].length; j++)
    ...
    {
        String msg = "";
        //if (gameboard[row1][col1].validateSelection() && gameboard[row2][col2].validateSelection())
   ...
   /* else
    ...
    {
        int rLength = gameboard.length;
        int cLength = gameboard[0].length;
